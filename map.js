window.TILE_VERSION = {
  ditu: {
    normal: { version: "088", updateDate: "20230707" },
    satellite: { version: "009", updateDate: "20230707" },
    normalTraffic: { version: "081", updateDate: "20230707" },
    satelliteTraffic: { version: "083", updateDate: "20230707" },
    mapJS: { version: "104", updateDate: "20230707" },
    satelliteStreet: { version: "083", updateDate: "20230707" },
    earthVector: { version: "001", updateDate: "20230707" },
  },
  webapp: {
    high_normal: { version: "001", updateDate: "20230707" },
    lower_normal: { version: "002", updateDate: "20230707" },
  },
  api_for_mobile: {
    vector: { version: "002", updateDate: "20230707" },
    vectorIcon: { version: "002", updateDate: "20230707" },
  },
};
window.BMAP_AUTHENTIC_KEY = "TvYKOGMeqBpXPCSqAciESN1p1xbtwmvI";
(function () {
  function aa(a) {
    throw a;
  }
  ...
  x.CL = (function () {
    ...
    a.prototype = {
      ...
      move: function (a) {
        ...
        if (
          10 <
            Math.abs((this.Hk ? a.touches[0].clientX : a.clientX) - this.Eu) ||
          10 < Math.abs(c - this.Fu)
        )
          this.uh = o;
      },
      end: function (a) {
      ...
      if (B.version && B.version >= 1.5) {
        ...
        qa(b, function (a) {
          if (a && a.error !== 0) {
            B = p;
            var b =
              "\u60a8\u63d0\u4f9b\u7684\u5bc6\u94a5\u4e0d\u662f\u6709\u6548\u7684\u767e\u5ea6LBS\u5f00\u653e\u5e73\u53f0\u5bc6\u94a5\u3002\u60a8\u53ef\u4ee5\u8bbf\u95ee\u5982\u4e0b\u7f51\u5740\u4e86\u89e3\u5982\u4f55\u83b7\u53d6\u6709\u6548\u7684\u5bc6\u94a5\uff1ahttp://lbsyun.baidu.com/apiconsole/key#\u3002";
            a.error &&
              ra[a.error] &&
              (b =
                ra[a.error] +
  ...
  function La(a, b) {
    if ((a = x.$(a))) {
      ...
      window.GCJMAP = this;
      c.B.ze && (this.RY(c.B.ze.controls), this.IM(c.B.ze.geotableId));
      ...
      c.sv();
      c.R = { Ic: q, lc: 0, Op: 0, ZM: 0, m4: 0, GC: q, IF: -1, Re: [] };
  ...
  x.extend(La.prototype, {
    ...
    ok: function (a, b, c, d) {
      var e = this.oa().yc(this.ga()),
        f = this.Nd,
        g = o;
      c && N.UE(c) && ((this.re = new K(c.lng, c.lat)), (g = q));
    ...
    Jg: function (a, b) {
      if (
        ...
        var c;
        b
          ? (c = new K($a(cp, me).lng, $a(b, me).lat))
          : this.mh() && (c = this.mh().ia());
        c &&
          ((c = this.Cc(c, this.Mc)),
          this.ok(
            this.width / 2 - c.x,
    ...
    Xf: function (a) {
      var b = this;
      if (a instanceof N || a instanceof K)
        (a = new K($a(a, b).lng, $a(a, b).lat)), b.Bi(a, { noAnimation: o });
      else if (cb(a))
        if (b.xb === Qa) {
          var c = I.KC[a];
          c && ((pt = c.m), b.Xf(pt));
          ...
          d.dG(function (c) {
            0 === d.Om() &&
              2 === d.Ha.result.type &&
              (b.Xf(c.Fk(0).point), Qa.Bk(a) && b.YF(a));
          });
    ...
    Gd: function (a, b) {
      "[object Undefined]" !== Object.prototype.toString.call(b) &&
        (b = parseInt(b));
      B.Vn("cus.fire", "time", { z_loadscripttime: ta - sa });
      var c = this;
      if (cb(a))
        if (c.xb === Qa) {
          var d = I.KC[a];
          ...
          e.dG(function (d) {
            if (
              0 === e.Om() &&
              (2 === e.Ha.result.type || 11 === e.Ha.result.type)
            ) {
              var d = d.Fk(0).point,
    ...
    UW: function () {
      this.B.ip = q;
      this.co && (this.Bh(this.co), (this.co = p), delete this.co);
    },
    vb: function () {
      return this.Ps && this.Ps instanceof L
        ? new L(this.Ps.width, this.Ps.height)
        : new L(500, 500);
    },
    Ce: function (a) {
      a && a instanceof L
    ...
    Cc: function (a, b) {
      b = b || this.ga();
      return this.Zp(a, b, this.dc, this.vb(), this.Sb);
    },
    Zp: function (a, b) {
      b = b || this.ga();
    ...
    I4: function (a, b) {
      ...
      this.xb === Qa &&
        c &&
        ((a.x += this.offsetX), (a.y += this.offsetY), ib.WK(a, this, b));
    },
    Kd: function (a) {
      ...
      var b = a || {},
        a = b.margins || [0, 0, 0, 0],
        c = b.zoom || p,
        b = this.Bg({ x: a[3], y: this.height - a[2] }, c),
        a = this.Bg({ x: this.width - a[1], y: a[0] }, c);
      return new jb(b, a);
    },
    oy: function () {
      return !!this.loaded;
    ...
    Dt: function (a, b) {
      ...
      if (
        ...
        (a instanceof jb && a.Bj())
      )
        return c;
      var d = [];
      a instanceof jb
        ? (d.push($a(a.pf(), this)), d.push($a(a.xe(), this)))
        : (d = a.slice(0));
    ...
    Qw: function (a, b) {
      ...
      a.tag = b;
      a instanceof mb && ((this.Th[b][a.ba] = a), a.ra(this));
      var c = this;
      Ua.load(
        "hotspot",
        function () {
    ...
    //   b.B.qj = q;
      ...
      if (a) {
        ...
        a.style &&
          (c = b.B.um[a.style]
            ? b.B.um[a.style].backColor
            : b.B.um.normal.backColor) &&
          (this.Ga().style.backgroundColor = c);
      }
    },
    RY: function (a) {
      this.controls ||
      ...
      var b = this,
        c;
      for (c in this.controls) b.kO(b.controls[c]);
      a = a || [];
    ...
    IM: function (a) {
      a
        ? (this.Ns && this.Ns.Bf === a) ||
          (this.Bh(this.Ns),
          (this.Ns = new rb({ geotableId: a })),
          this.ah(this.Ns))
        : this.Bh(this.Ns);
    },
    Wb: function () {
  ...
  x.da.Te
    ? (x.extend(I, {
      ...
      x.platform.VM && (I.fontFamily = "arial,simsun,sans-serif"))
    : x.da.gx || x.da.QF
    ? x.extend(I, {
          ...
          for (var c = a.target || a.srcElement; c != b; ) {
            Vb(b.dn, function (b, g) {
              RegExp(g.filter).test(c.getAttribute("filter")) &&
                g.Em.call(c, a, c.getAttribute("filter"));
            });
            c = c.parentNode;
          }
        },
    ...
    void (function (a, b, c) {
      function g(a) {
        if (!a.dp) {
          for (var c = o, d = [], f = a.e_, i = 0; f && i < f.length; i++) {
            var j = f[i],
              l = (ba[j] = ba[j] || {});
            if (l.dp || l == a) d.push(l.Lc);
            else {
              c = q;
              if (
                !l.NW &&
                ((j = (Ma.get("alias") || {})[j] || j + ".js"), !E[j])
              ) {
                E[j] = o;
      ...
      if (!D || !D.dp) {
        ...
        w.prototype.send = function (a, b) {
          var c = u({ ts: i().toString(36), t: a, sid: y }, this.ht);
        ...
        if (D) {
          ...
          for (D = 0; D < U.length; D++) G.apply(G, U[D]);
        }
        c.alog = G;
        C &&
          j(b, "mouseup", function (a) {
      ...
      if (s && s.Ch && j() < s.Ch) {
        var C = ["Moz", "O", "ms", "Webkit"],
          ...
          Xi = function () {
            return (
              !!b.createElementNS &&
              !!b.createElementNS("http://www.w3.org/2000/svg", "svg").H2
            );
          },
          Yi = function () {
            return !!a.z1;
          ...
          mj = function () {
            ...
            return (
              !!a.style.length && (b.documentMode === k || b.documentMode > 9)
            );
          },
          nj = function () {
            return (
        ...
        u.M("commit", function () {
          ...
          var a = setInterval(function () {
            if (
              "WebP-lossy" in Sb.pi &&
              "WebP-lossless" in Sb.pi &&
              "WebP-alpha" in Sb.pi &&
              "WebP-animation" in Sb.pi
            ) {
              for (var b in Sb.pi) Sb.pi[b] = Sb.pi[b] ? "y" : "n";
              u.send("feature", Sb.pi);
              clearInterval(a);
            }
          }, 500);
        });
        c.alog("feature.create", { S2: 4, M4: i, page: g, yb: "18" });
  ...
  Ac.prototype.contains = function (a) {
    return a.lng > this.xg.lng &&
      a.lng < this.Fg.lng &&
      a.lat > this.xg.lat &&
      a.lat < this.Fg.lat
      ? oc
      : Math.abs(a.lng - this.xg.lng) < pc ||
        Math.abs(a.lng - this.Fg.lng) < pc ||
        Math.abs(a.lat - this.xg.lat) < pc ||
        Math.abs(a.y - this.Fg.lat) > pc
      ? 2
      : nc;
  };
  Ac.prototype.normalize = function (a, b, c, d) {
    a > c
      ? ((this.xg.lng = c), (this.Fg.lng = a))
      : ((this.xg.lng = a), (this.Fg.lng = c));
    b > d
      ? ((this.xg.lat = d), (this.Fg.lat = b))
      : ((this.xg.lat = b), (this.Fg.lat = d));
  };
  function Bc(a, b, c, d) {
    this.Bu = { lng: a, lat: b };
    this.Hx = { lng: c, lat: d };
  ...
  function xc(a) {
    ...
    if ((0 === f ? nc : oc) === nc) {
      for (f = 0; f < bc; ++f)
        if (
          ((d = new Bc(cc[f], dc[f], cc[(f + 1) % bc], dc[(f + 1) % bc])),
          ...
          g = m - j;
          var n = i - l;
          !(Math.abs(g - 0) > pc) && !(Math.abs(n - 0) > pc)
            ? (g = d.Bu)
            : ((i = l * j - i * m),
              (j = n * a.lng - g * a.lat),
              (l = g * g - n * n),
              (g = { lng: (n * j - g * i) / l, lat: -(g * j + n * i) / l }));
          n = 180;
          i = 90;
          j = -180;
          l = -90;
          ...
          g.lng <= j && g.lng >= n && g.lng <= l && g.lat >= i
            ? ((d = a.lat * jc),
              (n = a.lng * jc),
              (i = g.lat * jc),
              (g = g.lng * jc),
              ...
              (d =
                j * Math.cos(n) * Math.cos(g) +
                j * Math.sin(n) * Math.sin(g) +
                Math.sin(d) * Math.sin(i)),
              -1 > d ? (d = -1) : 1 < d && (d = 1),
              (d = Math.acos(d) * qc))
            : ((g = Cc(a, d.Bu)), (d = Cc(a, d.Hx)), (d = g < d ? g : d));
          d < c && (c = d);
        }
      c < mc && (b = (mc - c) / mc);
    } else b = 1;
      ...
      set: function (a, f) {
        if (d) {
          for (var g = b + a + "_", i = c.length, j; i--; )
            (j = c.key(i)), -1 < j.indexOf(g) && c.removeItem(j);
          try {
  ...
  x.object.extend(Ua, {
    ...
    P4: {},
    QG: { MQ: B.la + "getmodules?v=2.0&t=20140707", lV: 5e3 },
    gD: q,
    Sd: { Hl: {}, Xn: [], uw: [] },
    load: function (a, b, c) {
      var d = this.jb(a);
      if (d.Dd == this.Lj.Aq) c && b();
      else {
        if (d.Dd == this.Lj.XG) {
          this.TK(a);
          this.hO(a);
    ...
    TK: function (a) {
      if (a && this.ZL()[a])
        for (var a = this.ZL()[a], b = 0; b < a.length; b++)
          this.TK(a[b]), this.Sd.Hl[a[b]] || this.hO(a[b]);
    },
    hO: function (a) {
      for (var b = 0; b < this.Sd.Xn.length; b++)
        if (this.Sd.Xn[b] == a) return;
      this.Sd.Xn.push(a);
    },
    k_: function (a, b) {
      var c = this.jb(a);
  ...
  (function (a) {
      ...
      return !b
        ? !c
          ? l(
              i(
                g(
                  j(unescape(encodeURIComponent(a))),
    ...
    "function" === typeof define && define.p2
      ? define(function () {
          return n;
        })
      : "object" === typeof module && module.pX
      ? (module.pX = n)
      : (a.md5 = n);
  })(this);
  function eb() {
    ...
    function b(a) {
      if (1 === arguments.length && "object" === typeof arguments[0]) {
        ...
        for (key in b)
          if (!b[key] || !(f[key] && b[key] === f[key]))
            if (b[key] || 0 === b[key]) f[key] = b[key];
      }
      (b = document.getElementById(f.dl)) &&
        b.parentNode &&
      ...
      g.X0 || g.W0
        ? c &&
          ...
          (f.fl += F),
          (f.gl += m))
        : c && ((m = c.offsetTop || 0), (F = c.offsetLeft || 0));
      var y = document.getElementById(f.dl),
        g = p;
      if (y) y.shadowRoot && (g = y.shadowRoot);
      else {
        ...
        var g =
            "function" === typeof y.attachShadow
              ? y.attachShadow({ mode: "closed" })
              : y,
          A = c.children,
      ...
      f.On = y ? f.On : y;
      b
        ? ((y = f.fl + f.Mn * f.cl + f.Nn * (f.cl - 1)),
          (A = f.gl + f.Ln * f.el + f.On * (f.el - 1)))
        : ((y = F + f.fl + f.Mn * f.cl + f.Nn * (f.cl - 1)),
          (A = m + f.gl + f.Ln * f.el + f.On * (f.el - 1)));
      for (var G, P = document.createDocumentFragment(), S = 0; S < f.el; S++) {
        G = b
          ? m + f.gl + (f.On + f.Ln) * S
          : f.gl + (e - A) / 2 + (f.On + f.Ln) * S;
        for (var ba = 0; ba < f.cl; ba++) {
          var E = b
              ? F + f.fl + (d - y) / 2 + (f.Mn + f.Nn) * ba
              : f.fl + (d - y) / 2 + (f.Mn + f.Nn) * ba,
      ...
      if ((a.rF === k ? f.rF : a.rF) && i)
        j.observe(c, l), j.observe(document.getElementById(f.dl), l);
    }
    function c(a) {
      if (e) e = q;
      else {
  ...
  for (
    var Kc = (function (a, b) {
        ...
        function d(a) {
          return f
            .adame(a, "")
            [f.dxeeh][f.adame(f.adame("from", "Char"), i)](a);
        }
        function e(a, b) {
        ...
        this,
        "SJv\u6a4aY\u72bah\u6b31\u692dZ\u6b9bh\u72ba\u735aHS\u706e\u56c4\u5ef2\u735c\u735ci\u706e\u56c4\u545al\u5e77\u56c4\u58a0\u56c4\u59c8l\u706e\u59c8\u59c8\u59c8\u735ch\u6730\u545a\u56c4\u735c\u5e77\u58a0\u59c8\u5ef2\u5ef2\u59c8\u706e\u735c\u545a\u735c\u58a0\u5ef2\u6c36\u5f5f\u6b31\u7209qt\u5f5f\u6b31\u6b9b\u735a\u5ef2\u72b8\u7313_\u545a\u72b8try\u5f5f\u66f0\u6c19v\u5f5f\u6b31\u6b9b\u706e\u5a32u\u72b8\u59c8ti\u7313\u72b8\u6730\u5f5f\u66f0\u6c19\u5f5f\u66f0\u5e52\u59c8\u5ef2ll\u5c2b\u5ef2\u59c8k\u5f5f\u6b31\u6b9b\u5e77ii\u545ai\u545a\u706e\u56c4\u59c8h\u56c4i\u624fh\u545a\u58a0i\u5ef2\u5e77\u545al\u59c8\u58a0l\u706e\u735c\u735c\u545a\u545a\u545a\u6c36P\u6256NOR\u6256M\u6256\u5e77\u5f5f\u6a4a\u5f6e\u5f5f\u5f6e\u645a\u5f5f\u62a1\u5e52\u5f5f\u6a4a\u62a1\u5f5f\u6256\u6c19\u5f5f\u62a1\u5fb4\u5f5f\u6a4a\u692d\u5f5f\u5f6e\u7074\u5f5f\u63cb\u6b31\u5f5f\u6a4a\u62a1\u5f5f\u6256\u7209\u5f5f\u63cb\u692d\u5f5f\u6a4a\u72ba\u5f5f\u62a1\u72ba\u5f5f\u6256\u62a1\u5f5f\u6a4a\u6c19\u5f5f\u5f6e\u5f6e\u5f5f\u6256\u7209\u5f5f\u6a4a\u72ba\u5f5f\u5f6e\u645a\u5f5f\u63cb\u5e52\u5f5f\u6a4a\u72ba\u5f5f\u5f6e\u63cb\u5f5f\u63cb\u6a4a\u5f5f\u6a4a\u7074\u5f5f\u63cb\u6b9b\u5f5f\u63cb\u7209\u5f5f\u6a4a\u692d\u5f5f\u5f6e\u7074\u5f5f\u6256\u62a1\u5f5f\u6a4a\u6c19\u5f5f\u5f6e\u6b9b\u5f5f\u62a1\u6b31\u5f5f\u6a4a\u5f6e\u5f5f\u5f6e\u5f6e\u5f5f\u5f6e\u5e52\u5e77\u545a\u545a\u545a\u56c4\u6c36\u735cil\u5e77\u5f5f\u6b31\u7209qt\u5f5f\u6b31\u6b9b\u735a\u5ef2\u72b8\u7313_\u59c8\u7313u\u72b8t\u5f5f\u66f0\u6c19v\u5f5f\u6b31\u6b9b\u6730\u5f5f\u66f0\u6c19\u5ef2k\u5f5f\u6b31\u6b9b\u706e\u545a\u5ef2\u545a\u6730hhl\u59c8\u6c36\u56c4h\u5ef2\u5e77\u735c\u5ef2\u59c8\u706e\u59c8\u5ef2i\u5e77\u56c4\u58a0\u56c4\u6730il\u545ah\u6730\u5ef2\u58a0\u5ef2\u5ef2\u545a\u624fi\u545al\u5ef2\u58a0\u5e77h\u58a0h\u59c8\u5ef2\u706e\u59c8i\u545a\u5ef2\u5ef2\u6730l\u735c\u5ef2hi\u6730\u56c4\u59c8\u545a\u6730\u59c8\u545a\u545a\u5ef2h\u6c36\u735cih\u5ef2\u735c\u706e\u5ef2\u735c\u545a\u545a\u58a0\u5e77\u58a0\u545al\u59c8\u545a\u706e\u5ef2i\u59c8\u5ef2\u545a\u6730\u5ef2\u56c4\u545a\u5e77i\u58a0\u5ef2\u6c36\u5ef2\u59c8\u545a\u706e\u545arr\u7313r\u624f\u59c8\u735c\u545a\u56c4\u735c\u6730\u5ef2\u58a0\u59c8\u545a\u545a\u6c36i\u58a0\u545ai\u59c8\u5e77i\u58a0h\u545ah\u624f\u5ef2\u58a0\u735c\u545a\u59c8\u5e77li\u56c4\u735c\u59c8\u706e\u545a\u59c8\u735clh\u624f\u5f5f\u66f0\u6c19\u59c8\u7313\u72b8su\u735c\u545a\u5f5f\u6b31\u6b9b\u706ehi\u58a0\u624f\u735cl\u56c4\u56c4\u735c\u5e77\u735ci\u56c4\u58a0\u5ef2\u5e77llih\u59c8\u624flh\u735c\u56c4\u735c\u706e\u5ef2\u58a0\u58a0\u5ef2\u58a0\u5e77\u58a0\u735c\u5ef2l\u58a0\u706e\u545a\u56c4\u56c4\u545a\u735c\u6730\u58a0\u58a0i\u6730\u5ef2\u56c4\u59c8\u706e\u56c4l\u545a\u6c36\u545ah\u5ef2\u624flh\u59c8\u706e\u5ef2\u5ef2\u59c8\u706e\u735c\u545al\u6730h\u735c\u5ef2\u624f\u56c4i\u545a\u706ei\u735c\u545a\u706ei\u545a\u59c8i\u5ef2\u6c36\u58a0\u735ci\u56c4\u6730l\u5ef2\u5ef2\u58a0i\u624f\u5ef2i\u58a0l\u5ef2\u6c36\u5ef2uth_k\u545ay\u5f5f\u6b31\u6b9b\u624fh\u58a0\u56c4\u56c4\u59c8\u6c36\u735a\u5ef2rs\u545a\u6c36\u545ai\u56c4\u706e\u545aih\u545a\u58a0\u6730\u735c\u58a0\u545a\u545ah\u6730i\u545ah"
      ),
      Lc = 261,
      Mc = ++Lc;
    --Mc;
    ...
    for (
      ...
      switch (d) {
        ...
        case c[V("0x36")]:
          var f =
              c.axmad(
                c[V("0x37")](V("0x38") + c[V("0x37")](e, i) + "-", g) +
                  "-" +
                  pa,
                "-"
              ) + l,
        ...
        case c[V("0x46")]:
          var s = c[V("0x37")](
              c[V("0x37")](c.aiald(c.iemlm(a, "-"), e + i) + "-" + g, "-") +
                pa +
                "-",
              j
            ),
  ...
  x.extend(mb.prototype, {
    ...
    ta: function (a) {
      if (a instanceof N || a instanceof K) this.Kb = a;
    },
    ia: v("Kb"),
    tu: ca("Yg"),
    AE: v("Yg"),
    ...
    Pw: function (a) {
      if (a && Za(a.id) && !isNaN(a.id)) {
        var b = { bounds: p, content: "" },
          c;
        for (c in a) b[c] = a[c];
        if ((a = this.Gm(a.id))) for (var d in b) a[d] = b[d];
        else this.bc.push(b);
      }
    },
    Gm: function (a) {
  ...
  x.object.extend(jb.prototype, {
    ...
    ab: function (a) {
      return !(a instanceof jb) || this.Bj()
        ? q
    ...
    pf: v("Kl"),
    tW: function (a) {
      return !(a instanceof jb) || this.Bj() || a.Bj()
        ? q
    ...
    pc: function () {
      return this.Bj()
        ? p
        : new N((this.Ne + this.Je) / 2, (this.$d + this.Yd) / 2);
    },
    Mt: function (a) {
      if (
        !(a instanceof jb) ||
    ...
    mx: function (a) {
      return !(a instanceof N || a instanceof K) || this.Bj()
        ? q
        : a.lng >= this.Ne &&
            a.lng <= this.Je &&
            a.lat >= this.$d &&
    ...
    sG: function () {
      return this.Bj()
        ? new N(0, 0)
        : new N(Math.abs(this.Je - this.Ne), Math.abs(this.Yd - this.$d));
    },
  });
  function N(a, b) {
  ...
  T(id.prototype, { translate: id.prototype.translate });
  function R() {}
  R.prototype = new gd();
  x.extend(R, {
    ZP: 6370996.81,
  ...
  B.Xe(function (a) {
    ...
    a.addEventListener("addoverlay", function (a) {
      a = a.target;
      if (a instanceof kb) b.wa[a.ba] || (b.wa[a.ba] = a);
      else {
    ...
    a.addEventListener("removeoverlay", function (a) {
      a = a.target;
      if (a instanceof kb) delete b.wa[a.ba];
      else
  ...
  ld.xF = [0.09, 0.005, 1.0e-4, 1.0e-5];
  x.extend(ld.prototype, {
    ...
    Bn: function (a, b) {
      b &&
        this.ha[a] &&
        ((this.gf.length = 0), (this.ha[a] = new K(b.lng, b.lat)), this.Jh());
    },
  ...
  x.extend(md.prototype, {
    Oj: function () {
      ...
      "none" != a.borderColor &&
        c.push("border:" + a.wy + "px " + a.mZ + " " + a.eN + ";");
      c.push(
    ...
    draw: function () {
      ...
      this.z.Aa = new L(
        -Math.round(this.z.width / 2) - Math.round(this.z.wy),
        -Math.round(this.z.height / 2) - Math.round(this.z.wy)
      );
  ...
  function sd(a, b, c, d) {
    a &&
      ...
      (this.qJ = !!(c.indexOf("%") + 1)),
      (this.repeat =
        c != k ? (this.qJ ? parseFloat(c) / 100 : parseFloat(c)) : 0));
  }
  function td(a, b) {
    x.lang.Da.call(this);
    this.content = a;
  ...
  x.extend(W.prototype, {
    ...
    po: v("point"),
    ia: function () {
      return this.point instanceof N || this.point instanceof K
        ? this.map
          ? hb(this.point, this.map)
          ...
          i = new N(
            (((f -
              Math.atan2(
                ...
                Math.cos(d) - Math.sin(e) * Math.sin(j)
              ) +
              Math.PI) %
              (2 * Math.PI)) -
              Math.PI) *
  ...
  x.extend(Gd.prototype, {
    ...
    zf: function () {
      ...
      var a = this;
      this.TE &&
        (this.map.dispatchEvent(new M("onfirsttileloaded")), (this.TE = q));
      0 == this.vh &&
        (this.Si && (clearTimeout(this.Si), (this.Si = p)),
    ...
    Rm: function (a, b, c) {
      ...
      for (d = a.childNodes.length; l < d; l++)
        (w = a.childNodes[l]), (w.Hr = q), this.Oe.push(w);
      if ((l = this.hn)) for (var C in l) delete l[C];
      else this.hn = {};
      ...
      for (d = this.Oe.length; l < d; l++)
        (n = this.Oe[l]), n.Hr || this.Pe.push(n);
      this.Gn = [];
    ...
    Z_: function (a, b, c, d) {
      ...
      j && j.Hb
        ...
        : (j = this.ij[g]) && j.Hb
        ? (c.Pb.insertBefore(j.Hb, c.Pb.lastChild),
          (this.yg[g] = j),
          Ab(j.Hb, b),
          d &&
            ((d = new Q(a[0], a[1])),
          ...
          if (a.vh == 0) {
            ...
            if (va) {
              if (sa && ta && ua) {
                ...
                B.Vn("cus.fire", "time", { z_imgfirstloaded: b - ua });
              }
              va = q;
            }
          }
    ...
    bW: function (a, b) {
      for (
        var c = 256 * Math.pow(2, 18 - b),
          d = Math.floor(this.uB / c),
          e = Math.floor(this.UI / c),
          c = Math.floor(this.rB / c),
          f = [],
          g = 0;
        g < a.length;
        g++
    ...
    Vf: function (a) {
      ...
      if (b.map.oa() == Qa)
        Ua.load(
          ...
          function () {
            b.map.Sb ||
              ((b.map.Sb = Qa.Bk(b.map.dh)), (b.map.hx = Qa.VL(b.map.Sb)));
            b.XI();
          },
          o
        );
    ...
    XI: function (a) {
      ...
      for (var g = 0; g < c; g++) {
        ...
        if (!i.JI && !((i.Mp && !this.map.Wb()) || (i.TM && this.map.Wb()))) {
          ...
          w = [];
          for (d.pC = []; n < u; n++)
            for (z = l; z < e; z++) w.push([n, z]), d.pC.push({ x: n, y: z });
          ...
          for (n = 0; n < m; n++) {
            if (
              i.MO === o &&
              ((l = this.Ds(w[n][0], f)), l.tm > j - 1 || l.tm < -j)
            )
              continue;
    ...
    ah: function (a) {
      var b = this,
        c = a.target,
        a = b.map.Wb();
      if (c instanceof gb) a && !c.Xm && (c.ra(this.map, this.nd), (c.Xm = o));
      else if ((c.Hh && this.map.ah(c.Hh), c.Mp)) {
    ...
    Bh: function (a) {
      var a = a.target,
        b = this.map.Wb();
      if (a instanceof gb) b && a.Xm && (a.remove(), (a.Xm = q));
      else {
    ...
    pu: function (a) {
      var b = this.map.oa();
      if (!this.map.Wb() && (a ? (this.map.B.g0 = a) : (a = this.map.B.g0), a))
        for (
          var c = p,
            c =
              "2" == B.xz
  ...
  function Md(a) {
    if (a) {
      ...
      if (b) {
        d = b.length;
        for (c = 0; c < d; c += 1)
          (e = b[c].name), "unknown" !== typeof a[e] && ab(a[e]) && (a[e] = p);
      }
      if ((b = a.children)) {
        d = b.length;
  ...
  function rb(a, b) {
    ...
    d && ((this.Hh = new Pd(a, b)), (this.Hh.pG = this));
    Lb(a) ? (b = a || {}) : ((c.jo = a), (b = b || {}));
    ...
    c.oc = {
      ...
      o0: "png",
      b4: [5, 5, 5, 5],
      jZ: { backgroundColor: "#FFFFD5", borderColor: "#808080" },
      hm: b.ak || pa,
      uz: b.tags || "",
      filter: b.filter || "",
      oz: b.sortby || "",
  ...
  $d.getTilesUrl = function (a, b) {
    ...
    return (url =
      this.aP[Math.abs(c + d) % this.aP.length] +
      this.map.Sb +
      "/" +
      this.map.hx +
      "/3/lv" +
  ...
  var Fe = Ee.prototype;
  T(Fe, { getPoint: Fe.Mm, getLocation: Fe.Im });
  ...
  function Pa(a, b) {
    ...
    B._rd["_cbk" + f] = function (a) {
      if (!a || a.error === k || a.error !== 0) Oc("PANORAMA");
      else {
        this.jk === "flashRender"
          ? Ua.load(
              "panoramaflash",
    ...
    this.k.AT !== o &&
      (this.vo(), B.Vn("cus.fire", "count", "z_loadpanoramacount"));
    this.qU(this.C);
  ...
  x.extend(Pa.prototype, {
    ...
    $B: function () {
      if (this.D)
        for (var a = this.D.Yx(), b = 0; b < a.length; b++)
          (a[b] instanceof W || a[b] instanceof ud) &&
            a[b].point &&
            this.wa.push(a[b]);
    },
    cz: ca("D"),
    ...
    Ar: function () {
      return Xa() && !J() && "javascript" !== this.k.panoramaRenderer
        ? "flashRender"
        : !J() && Qb()
        ? "cvsRender"
        : "cssRender";
  ...
  x.extend(Ue.prototype, {
    ...
    oo: function () {
      var a = 0,
        ...
        c;
      this.P &&
        ((b = this.P.ia()), (c = this.ia()) && !c.ab(b) && (a = R.rp(b, c)));
      return a;
    },
    U: function () {
      aa("hide\u65b9\u6cd5\u672a\u5b9e\u73b0");
      ...
      function a(a) {
        if (a) {
          if (a.id != b.zw) {
            ...
            a.pm
              ? (b.Fj({ haveBreakId: o }),
                Xa() && b.k.closeControl && x.K.show(b.Dr))
              : x.K.U(b.Dr);
          }
        } else
          (b.Ya = b.Dl), (b.Kb = b.El), b.dispatchEvent(new M("onnoresult"));
      }
      var b = this.P,
        c = this;
  ...
  x.extend(cf, {
    YW: function (a, b, c) {
      ...
      b = { data: b };
      "position_changed" == a &&
        (b.data = cf.Xd.Ej(new Q(b.data.mercatorX, b.data.mercatorY)));
      c.dispatchEvent(new M("on" + a), b);
    },
  });
  var df = cf;
  T(df, { dispatchFlashEvent: df.YW });
  var ef = { cQ: 50 };
  ef.ev = B.Sf("pano")[0];
    ...
    Ip: function (a, b, c, d) {
      if (!b || !c || !c.lngLat || !c.panoInstance) d();
        ...
        this.Ao.IC(b, function (b) {
          b
            ? e.Ao.uj(c.lngLat, ef.cQ, function (b) {
                if (b && b.id) {
                  var f = b.id,
                    j = b.xh,
                    b = b.yh,
  ...
  var ff = document,
    gf = Math,
    hf = ff.createElement("div").style,
    jf;
  a: {
    for (
      var kf = ["t", "webkitT", "MozT", "msT", "OT"],
        lf,
        mf = 0,
        nf = kf.length;
      mf < nf;
  ...
  var of = jf ? "-" + jf.toLowerCase() + "-" : "",
    ...
    Df = zf ? "touchstart" : "mouswindow.edown",
  ...
  function Nf(a, b) {
    ...
    c.options.bl
      ? (c.Nb.style[qf] = "translate(" + c.x + "px," + c.y + "px)" + Mf)
      : (c.Nb.style.cssText +=
    ...
    this.options.ey &&
      (Event.prototype.stopImmediatePropagation ||
        ((document.body.removeEventListener = function (a, b, c) {
          ...
          a === "click"
            ? d.call(document.body, a, b.yM || b, c)
  ...
  Nf.prototype = {
    ...
    gR: function () {
      !this.uh &&
        ...
        !(
          this.km ||
          (this.az == this.Nb.offsetWidth * this.scale &&
            this.hq == this.Nb.offsetHeight * this.scale)
        ) &&
        this.refresh();
    },
    hw: function (a) {
      ...
      this[a + "Scrollbar"]
        ? (this[a + "ScrollbarWrapper"] ||
            ...
            this.options.SF
              ? (b.className = this.options.SF + a.toUpperCase())
              : (b.style.cssText =
    ...
    UB: function (a, b) {
      ...
      this[a + "Scrollbar"] &&
        ...
        0 > c
          ? (this.options.XD ||
              ((c = this[a + "ScrollbarIndicatorSize"] + gf.round(3 * c)),
              8 > c && (c = 8),
          ...
          : c > this[a + "ScrollbarMaxScroll"] &&
            (this.options.XD
              ...
              : ((c =
                  ...
                  gf.round(3 * (c - this[a + "ScrollbarMaxScroll"]))),
                8 > c && (c = 8),
                (this[a + "ScrollbarIndicator"].style[
                  "h" == a ? "width" : "height"
                ] = c + "px"),
        ...
        (this[a + "ScrollbarWrapper"].style.opacity =
          b && this.options.hy ? "0" : "1"),
        (this[a + "ScrollbarIndicator"].style[qf] =
          "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + Mf));
    },
    rR: function (a) {
      if (a.mS === o) return (this.rC = a.target), (this.Ix = Date.now()), o;
      if (this.rC && this.Ix) {
    ...
    sw: function (a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          zf &&
          1 < a.touches.length &&
          ((d = gf.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (c = gf.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.u0 = gf.sqrt(d * d + c * c)),
          (this.Ly =
            gf.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.CG) / 2 -
            this.x),
          (this.My =
            gf.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.DG) / 2 -
            this.y),
      ...
      if (this.options.zoom && zf && 1 < a.touches.length)
        ...
        (6 > this.Jw && 6 > this.Kw) ||
          (this.options.jF &&
            (this.Jw > this.Kw + 5
              ? ((f = this.y), (d = 0))
              : this.Kw > this.Jw + 5 && ((e = this.x), (c = 0))),
          (this.uh = o),
          this.Zr(e, f),
          (this.kD = 0 < c ? -1 : 0 > c ? 1 : 0),
          (this.lD = 0 < d ? -1 : 0 > d ? 1 : 0),
          300 < g - this.startTime &&
            ((this.startTime = g), (this.Eu = this.x), (this.Fu = this.y)),
      ...
      if (!(zf && 0 !== a.touches.length)) {
        ...
        if (b.jl)
          ...
          if (b.uh) {
            ...
            f.Ca || g.Ca
              ? ((c = gf.max(gf.max(f.time, g.time), 10)),
                b.options.Au &&
                  ((f = d - b.Lw),
                  (g = e - b.Mw),
                  gf.abs(f) < b.options.nz && gf.abs(g) < b.options.nz
                    ? b.scrollTo(b.Lw, b.Mw, 200)
                    : ((f = b.PJ(d, e)),
                      (d = f.x),
                      (e = f.y),
                      (c = gf.max(f.time, c)))),
                b.scrollTo(gf.round(d), gf.round(e), c))
              : b.options.Au
              ? ((f = d - b.Lw),
                (g = e - b.Mw),
                gf.abs(f) < b.options.nz && gf.abs(g) < b.options.nz
    ...
    Co: function (a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.uh &&
            ((this.uh = q), this.options.Jy && this.options.Jy.call(this)),
          this.ti &&
            this.options.hy &&
            ("webkit" == jf && (this.wM.style[vf] = "300ms"),
    ...
    PJ: function (a, b) {
      ...
      a = this.Ve[e];
      d = (d = gf.abs(a - this.Ve[this.bD]))
        ? 500 * (gf.abs(this.x - a) / d)
        : 0;
      this.bD = e;
      e = this.vf.length - 1;
      for (c = 0; c < e; c++)
      ...
      b = this.vf[e];
      c = (c = gf.abs(b - this.vf[this.cD]))
        ? 500 * (gf.abs(this.y - b) / c)
        : 0;
      this.cD = e;
    ...
    refresh: function () {
      ...
      this.Jn =
        this.options.Jn &&
        ((!this.options.WV && !this.Ep) || this.hq > this.Qn);
    ...
    scrollTo: function (a, b, c, d) {
      var e = a;
      this.stop();
      e.length || (e = [{ x: a, y: b, time: c, ZZ: d }]);
      a = 0;
      for (b = e.length; a < b; a++)
        e[a].ZZ && ((e[a].x = this.x - e[a].x), (e[a].y = this.y - e[a].y)),
    ...
    zoom: function (a, b, c, d) {
      ...
      this.options.bl &&
        ...
        (this.Nb.style[qf] =
          "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Mf),
        (this.jl = q));
    },
  };
  function pf(a) {
  ...
  B.kn(function (a) {
    ...
    a.addEventListener("position_changed", function () {
      a.k.visible &&
        a.k.albumsControl === o &&
        (b ? b.Vy(a.Yb()) : ((b = new Of(a.k.albumsControlOptions)), b.ra(a)));
    });
  ...
  x.extend(Of.prototype, {
    ...
    Vy: function (a, b) {
      if (
        ...
        !b && -1 !== d && this.hk[d] && 3 !== this.hk[d].recoType
          ...
          : this.mY(function (a) {
              for (
                var b = {}, d, i, j = q, l = [], m = 0, n = a.length;
                m < n;
                m++
              )
                (d = a[m].catlog),
                  ...
                  k !== d &&
                    ("" === d && k !== i
                      ? ((j = o), b[i] || (b[i] = []), b[i].push(a[m]))
                      : (b[Qf[d]] || (b[Qf[d]] = []), b[Qf[d]].push(a[m])));
              for (var s in b)
                j
                  ? l.push({ data: s + "F", index: s })
                  : l.push({ data: Rf[s], index: s });
              c.CH = b;
              c.Ui = l;
              c.Tl(a);
    ...
    GW: function () {
      if (!this.Ri) {
        ...
        new Nf(a, { Yo: q, Dy: o, ti: q, Ii: q, Jn: q, jF: o, fx: o, ey: o });
    ...
    DW: function () {
      if (this.Ri) (a = this.UL(this.Ui)), (this.fR.innerHTML = a);
      else {
    ...
    EW: function () {
      if (this.Ui && !(0 >= this.Ui.length)) {
        ...
        this.Ri &&
          (this.Ri.style.left =
            parseInt(this.Ri.style.left, 10) + this.fg.width + 8 + "px");
        var b = this;
    ...
    Tl: function (a) {
      ...
      this.k.showCatalog &&
        (0 < this.Ui.length
          ? (Xa() ? this.DW() : this.GW(), (this.Pc.offsetLeft = 60))
          : (this.gt &&
              (this.C.removeChild(this.gt),
              (this.gt = p),
              (this.Pc.gg.style.left = "0px")),
            this.Ri && (this.C.removeChild(this.Ri), (this.Ri = p)),
      ...
      b < a - 2 * this.Pc.Li - this.Pc.offsetLeft
        ? (this.C.style.width = b + this.Pc.offsetLeft + "px")
        : ((this.C.style.width =
            isNaN(Number(this.k.maxWidth)) === o
              ? this.k.maxWidth
              : this.k.maxWidth + "px"),
          b < this.C.offsetWidth - 2 * this.Pc.Li - this.Pc.offsetLeft &&
            (this.C.style.width = b + this.Pc.offsetLeft + "px"));
      this.Pc.refresh();
    ...
    VX: function (a) {
      for (
        var b, c, d, e, f = [], g = this.fg.height, i = this.fg.width, j = 0;
        j < a.length;
        j++
      )
        (b = a[j]),
          ...
          3 === recoType
            ? Xa()
              ? ((this.DA = b), (this.oX = d), a.splice(j, 1), j--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  j +
                  '"><img style="width:' +
    ...
    refresh: function () {
      ...
      this.gg &&
        (this.gg.children[0].style.marginTop =
          this.es.children[0].style.marginTop =
    ...
    scrollTo: function (a) {
      a =
        a < this.Xg.offsetLeft
          ? Math.ceil((a - this.Li - this.yo) / this.ls) * this.ls +
            this.yo +
            this.Li -
            8
          : Math.ceil((a - this.Li) / this.ls) * this.ls + this.Li;
  ...
  var Vf = R.prototype;
  T(Vf, { lngLatToPoint: Vf.xy, pointToLngLat: Vf.Ej });
  var Wf = lb.prototype;
  T(Wf, { lngLatToPoint: Wf.xy, pointToLngLat: Wf.Ej });
  var Xf = jb.prototype;
  T(Xf, {
    equals: Xf.ab,
    containsPoint: Xf.mx,
  ...
  var Yf = jd.prototype;
  T(Yf, { isVisible: Yf.vg, show: Yf.show, hide: Yf.U });
  jd.getZIndex = jd.Sm;
  var Zf = kb.prototype;
  T(Zf, {
  ...
  var gg = Cd.prototype;
  T(gg, { getPath: gg.ve, setPath: gg.me, setPositionAt: gg.Bn });
  var hg = mb.prototype;
  T(hg, {
    getPosition: hg.ia,
    setPosition: hg.ta,
  ...
  var jg = nb.prototype;
  T(jg, { getType: jg.Cp, setType: jg.Cn });
  T(window, {
  ...
  var kg = pb.prototype;
  T(kg, { changeView: kg.se, setSize: kg.Ce, getSize: kg.vb });
  var lg = ob.prototype;
  T(lg, { getUnit: lg.BY, setUnit: lg.fG });
  ...
  var ng = Hd.prototype;
  T(ng, { getMapType: ng.oa, getCopyright: ng.Gm, isTransparentPng: ng.St });
  var og = cd.prototype;
  T(og, { addItem: og.Rw, addSeparator: og.vC, removeSeparator: og.LF });
  var pg = fd.prototype;
  T(pg, { setText: pg.tu });
  var qg = Y.prototype;
  T(qg, {
  ...
  var rg = ue.prototype;
  T(rg, { clearResults: rg.Qe });
  we = ve.prototype;
  T(we, { setPolicy: we.su, toString: we.toString, setPageCapacity: we.mq });
  T(window, {
  ...
  var sg = De.prototype;
  T(sg, { routeCall: sg.vO });
  T(window, { BMAP_HIGHLIGHT_STEP: 1, BMAP_HIGHLIGHT_ROUTE: 2 });
  T(window, { BMAP_ROUTE_TYPE_DRIVING: fe, BMAP_ROUTE_TYPE_WALKING: ee });
  T(window, {
